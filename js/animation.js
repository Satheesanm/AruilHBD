...
document.querySelector(".btn-ref p").innerHTML = "Click the Bulb Arulini.";
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        light.play();
        transition(blackbox);
        document.querySelector(".btn-ref p").innerHTML = "Arulini, Click the Door ";
        setTimeout(function() {
        ...
        */
        ...
        door.play();
        transition(hallway);
        document.querySelector(".btn-ref p").innerHTML = "Click the Gift Arulini";
        setTimeout(function() {
